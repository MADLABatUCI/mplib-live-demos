...
/*
    ...
    Add trial counter so they know how far into the task they are.
    X / 5

    Longer puase in between tasks
    the puase screen can say what task number is about to start

    Remove the end session button.

    Set up different codes on prolific for different termination edge cases.
*/
...
let GameName = "groupestimation-live";
let NumPlayers = 3;
...
instructionsText.innerHTML = `
    ...
    <br />
    <p>
        <b>All players must make an estimate before the next task is shown.</b>
    </p>
    <br />
`;
...
//      Consent Terms
consentTerms.addEventListener('click', function () {
    /*
